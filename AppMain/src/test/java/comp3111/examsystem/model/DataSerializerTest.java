...
class DataSerializerTest {
    ...
    void serializerTest() throws JsonProcessingException {
        ...
        var string = """
                        {"courses":[{"id":4,"code":"COMP","name":"Programming I","department":"CS"}],"exams":[{"id":3,"name":"Midterm","duration":60,"courseId":4,"published":false,"questionIds":[1]}],"grades":[{"examId":3,"studentId":1,"points":95}],"managers":[{"username":"john.smith","password":"123456"}],"questions":[{"id":1,"title":"1+1=","a":"1","b":"2","c":"11","d":"10","answer":"B","points":4}],"students":[{"id":1,"username":"john@ust.hk","password":"123456","name":"John","age":20,"department":"CS","gender":"male"},{"id":2,"username":"jane@ust.hk","password":"123456","name":"Jane","age":22,"department":"CS","gender":"female"}],"teachers":[{"id":1,"username":"john@ust.hk","password":"123456","name":"John","age":20,"department":"CS","position":"Assistant Professor"}]}""";
